...
def Game_Start ():
  ...
  while choices not in Choices_List:
    print("As you turn around, you see a Waylayman. He asks youn are you a merchant? \n - yes \n - no.")
    choices = input()
    if choices == "yes":
      print("Maybe I can interest you in some of my goods. It seems something is troubling you, can I help you? \n Can you please help me with directions? \n To the West there is a village, to your North there is a forest and to the East is a bandit camp.")
      sleep(5)
      clear()
...
def Game_Start_Directions ():
  ...
  while part1locations not in gamestartDirections:
    print("Please enter if you wish to go to: \n - village, \n - forest \n - bandit camp")
...
def Part_1_The_Forest ():
  ...
  while mountainchoice not in flowertype:
    ...
    if mountainchoice == "flower":
      ...
      print("This is the one, as a reward I shall give you this antidote to cure poisons. \n As you plan to leave, the Dragon appears.")
      global inventory
...
def Part_1_The_Bandit_Camp ():
  ...
  while banditachoice not in playerbanditactions:
    ...
    if banditachoice == "work with Bandits":
      ...
      print("You decide to fight the bandits and are wounded. After being taken prisoner, they then try to use you as bait to defeat the dragon. \n The dragon ills them off and you run.")
      sleep(5)
      clear()
      Part_1_Dragon_Attack ()
...
def part2b():
    print("")
    answer_side = input("As you attempt to follow him using your watch, you see you are now at a shipyard. You can either go North or South, \n which way do you want to go. \n - north \n - south \n").lower()
...
def hiding():
    print("")
    answer_hiding = input("Where will you go? Hide in one of the crates, slip inside the ship, or head to the reception area? \n where would you like to go: \n - crates \n - ship \n - reception \n").lower()
...
def crates():
    print("")
    answer_crate = input("You see two crates: one marked with a dragon symbol and the other unmarked. \n Which one do you hide in? \n - marked \n - unmarked \n").lower()
...
def dragon_crate():
    ...
    answer_dragon = input("You hastily leave the crate, your heart pounding. \n Do you try the other crate? \n - yes \n - no \n").lower()
...
def ship():
  ...
  if element == "Wind":
    ...
    crate_again = input("Do you opt for the crates instead? \n - yes \n - no \n").lower()
...
def reception():
    print("")
    reception_ans = input("You reach the reception area, finding it deserted. The reception desk is empty. \n Do you take a moment to look around before venturing into the backroom? \n - yes \n - no \n ").lower()
...
def office():
  ...
  key_or_not = input("Do you look around? \n yes \n no \n").lower()
