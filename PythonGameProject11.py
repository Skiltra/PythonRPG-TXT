...
def Game_Start_Directions ():
  ...
  part1locations = ""
  while part1locations not in Directions:
    ...
    if part1locations == "west 2":
      print("This is the village.")
      Part_1_The_Village ()
    elif part1locations == "north 2 east 1":
      print("This is the forest.")
      Part_1_The_Forest ()
    elif part1locations == "east 2":
...
def Part_1_The_Village ():
  ...
  part1choices = ""
  while part1choices not in directions:
...
def Part_1_The_Forest ():
  ...
  mountainchoice = ""
  while mountainchoice not in directions:
...
def Part_1_The_Bandit_Camp ():
  ...
  banditachoice = ""
  while banditachoice not in Directions:
...
def Part_1_Dragon_Attack ():
    ...
    dragonaction = ""
    while dragonaction not in Directions:
...
def P2_suprisemysteryman ():
  ...
  mysteriousfigure = ""
  while mysteriousfigure not in directions:
...
def Puzzle ():
  ...
  elementspuzzle = ""
  global health
  while elementspuzzle not in outcomes:
...
def Part_2_Bridge ():
  directions = ["cross bridge", "go back_start"]
  part2bridge = ""
  print("You come across and old rickety bridge")
  while part2bridge not in directions:
...
def Part_2_Cave ():
  directions= ["proceed", "back"]
  print("You stand at the entrance of a dark ominous cave.")
  part2cave = ""
  while part2cave not in directions:
...
def P3_mysteryAmbush(): # need direction into other function
    ...
    while inventortaddstaus not in Directions:
...
def P3_dragoncompanion():
    ...
    helperfordragon = ""
    global health, inventory
    while helperfordragon not in Directions:
...
def P3_barelydragon():
    ...
    fightrecord = ""
    global health, inventory
    while fightrecord not in Directions:
      if health >= 60:
...
def P3_windragon():
  Directions = ["", ""]
  beatdragon = ""
  while beatdragon not in Directions:
    if health >= 40:
